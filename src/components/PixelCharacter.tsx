...
> = {
  ...
  // 소환사 (드루이드): 밝은 황금 로브 + 후드 위에 자라난 잎사귀.
  // 따뜻한 햇살 골드 톤으로 자연의 정령을 부르는 사도 컨셉.
  // 공격 시 양옆 황금 정령들이 휘몰아치며 우측 적에게 쏟아짐.
  summoner: {
    idle: [
      [
        "....L.....L.....",
      ...
      // idle 보조 — 정령들이 살짝 위로 떠오르고 잎사귀가 살랑이듯 흔들림
      [
        "....L.....L.....",
        "....hhhhhhhL....",
        "...hhhhhhhhh....",
...
const PALETTES: Record<CharacterId, Palette> = {
  ...
  // 소환사 (드루이드): 밝은 황금 로브 + 잎사귀 액센트.
  // 햇살 골드 톤으로 자연/생명의 정령 사도 분위기 통일.
  summoner: {
    o: "#0a0610",
    e: "#fff5b1", // 햇살 머금은 황금 영안
    h: "#e6c374", // 후드 본색 (가을 잎의 황금)
    H: "#a87a2a", // 후드 그림자 (깊은 호박색 그늘)
    c: "#f0c97c", // 로브 본색 (밝은 햇살 골드)
    C: "#bd8434", // 로브 외곽/안감 (깊은 골드)
    g: "#fff5c2", // 황금 메달리온 (드루이드 상징)
    G: "#fff5c2", // 소환된 정령의 발광 (밝은 빛)
    L: "#7cd66a", // 후드 위 잎사귀 (자연/드루이드 상징)
  },
};
