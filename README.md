...
| ⚫ **마왕성** | N1 | **1,438** | PDF 어휘 844 + 문법 594 (형식판단 266 + 문장완성 205 + 문맥이해 123) |

> 💡 N5 ~ N1 전 **4,808단어** (총 **9,616 예문**) 가 빠짐없이 *한자/구조 어원 풀이* + *실전 예문 2개* 를 갖추고 있어 시험 + 실사용 둘 다 노립니다.
> 외래어는 원어(영어·프랑스어·독일어·러시아어·네덜란드어 등) 풀이, 의태어·의성어는 음성 상징 풀이, 한자어는 한자별 자원(字源) 풀이로 일관됩니다.
> N5/N4/N3/N2 의 유의 표현은 양쪽 모두 자체 단어 entry 로 등록하고, 관계는 `word_relations` 테이블의 양방향 `synonym` 으로 관리합니다.
