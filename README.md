...
| 던전 | 레벨 | 단어 수 | 비고 |
|:---:|:---:|---:|---|
| 🟢 **초원** | N5 | **451** | PDF 어휘 248 + 관용구 6 + 유의 표현 128 (64쌍) + 「파이널 문법 체크북」 69 |
| 🟡 **숲속** | N4 | **452** | PDF 어휘 288 + 유의 표현 98 (49쌍) + 「파이널 문법 체크북」 66 |
| 🟠 **던전** | N3 | **867** | PDF 어휘 450 + 유의 표현 134 (67쌍) + 「파이널 문법 체크북」 283 (형식판단 179 + 문장완성 51 + 문맥이해 53) |
| 🔴 **화산** | N2 | **1,600** | PDF 어휘 906 + 문법 588 (형식판단 327 + 문장완성 141 + 문맥이해 120) + 유의 표현 106 (53쌍) |
| ⚫ **마왕성** | N1 | **1,583** | PDF 어휘 989 + 문법 594 (형식판단 266 + 문장완성 205 + 문맥이해 123) + 유의 표현 320 (어휘 154쌍 + 문법 6쌍) |

> 💡 N5 ~ N1 전 **4,953단어** (총 **9,906 예문**) 가 빠짐없이 *한자/구조 어원 풀이* + *실전 예문 2개* 를 갖추고 있어 시험 + 실사용 둘 다 노립니다.
> 외래어는 원어(영어·프랑스어·독일어·러시아어·네덜란드어 등) 풀이, 의태어·의성어는 음성 상징 풀이, 한자어는 한자별 자원(字源) 풀이로 일관됩니다.
> N5/N4/N3/N2/N1 모든 레벨의 유의 표현은 양쪽 모두 자체 단어 entry 로 등록하고, 관계는 `word_relations` 테이블의 양방향 `synonym` 으로 관리합니다.
> N3·N2·N1 의 문법은 `part_of_speech` 가 `문법-형식판단 / 문법-문장완성 / 문법-문맥이해` 로 세분 분류됩니다.
